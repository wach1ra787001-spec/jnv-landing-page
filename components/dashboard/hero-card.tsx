          ...
          <div className="flex items-center gap-2" aria-label="Last five trades">
            {recentTrades.map((trade, index) => {
              ...
              return (
                <div
                  key={trade.id}
                  className={`flex w-fit min-w-0 flex-none items-center justify-center rounded-md px-1 py-1 text-[10px] font-semibold sm:min-w-12 sm:px-2 sm:py-2 sm:text-xs ${isWin ? "bg-emerald-100 text-emerald-700" : "bg-red-100 text-red-700"}`}
