...
export function DayToDayCard({ snapshot, trend, currency }: DayToDayCardProps) {
  const {
    hasTrades,
    pnlAmount,
    pnlPercent,
  ...
  return (
    <Card className="p-4 sm:p-6 bg-card border border-border/50 shadow-sm">
      <div className="flex items-center justify-between gap-3 mb-5">
        ...
        <Badge variant="secondary" className={cn("shrink-0 text-[10px] sm:text-xs border-0", journalConfig.className)}>
          {journalConfig.label}
        </Badge>
      </div>
